                        ...
                        [
                            {
                                stack: [
                                    ...
                                    data.client.bankName ? `${l.bank}: ${data.client.bankName}` : '',
                                    data.client.bankCode ? `${l.code}: ${data.client.bankCode}` : '',
                                    data.client.bankAccount ? `${l.account}: ${data.client.bankAccount}` : '',
                                ].filter(Boolean),
                                fillColor: '#f8fafc',
